...
#Скачивание конфига
curl -f https://raw.githubusercontent.com/medvedicos/getconfig/refs/heads/main/kaliningrad/tis-dialog/getconfig --output /etc/init.d/getconfig
chmod +x /etc/init.d/getconfig
/etc/init.d/getconfig enable
/etc/init.d/getconfig start

#Скачивание исключений
